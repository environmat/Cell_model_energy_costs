...
LFP_cathode = Cellmodel.Activematerial_cathode("LFP", 165, 3.3)
...
# Ni, Co, Mn, Li, Al = Cellmodel.getMass_elements_cyl_c(positive, Al, LFP_cathode, test_cell)
...
LiOH_kg = LiOH/1000
# 2020 https://www.fastmarkets.com/insights/lithium-carbonate-premium-over-hydroxide-to-persist-in-new-year-sources-say-2022-preview
Li_CO3_kg_2020 = 7
LiOH_kg_2020 = 9
...
# Printing Info: 
print("Cell:",positive.active_material)
