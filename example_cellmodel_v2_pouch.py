...
Ni_costs, Co_costs, Mn_costs, Li_costs, Al_costs, Al_cc_costs, Gr_costs, Cu_costs, \
    ...
    Cellmodel.getCosts_pouch(Ni_raw, Co_raw, Mn_raw, Li_raw, Al_raw, Al_cc_raw, Gr_raw, \
                           Cu_raw, Binder_raw, Elyte_raw, Separator_raw, pouch_packaging, Conductive_raw, LP40_standard)
