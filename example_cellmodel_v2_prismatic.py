...
### Total cells
# Prismatic
test_cell = Cellmodel.Prismatic("NMC-Gr_Cyl", positive, negative, Separator_standard , LP40_standard, 
                              1.7, 9.1, 14.8, 2.7, 0.025, 7.9, 0.5, 18, 20, 0.94, NMC_cathode, Gr, Al, Cu)
 
 
# Masses
cellmass, prismatic_packaging_mass = Cellmodel.getMass_prismatic_total(positive, negative, Al, Cu, Separator_standard, test_cell, LP40_standard)

## Cathode Masses
# Prismatic 
cathode_mass = Cellmodel.getMass_cathode(positive) * test_cell.jr_area * test_cell.nrolls
